            ...
            >
                ...
                <div className="flex items-center gap-2 shrink-0">
                    ...
                    >
                        ...
                        <div className="bg-white rounded-full p-1 flex items-center justify-center transition-all duration-300 group-hover:-translate-y-1 group-hover:scale-110 group-hover:drop-shadow-xl">
